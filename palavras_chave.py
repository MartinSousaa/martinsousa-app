...
def pagina_palavras_chave(usuario_logado):
    ...
    busca = st.text_input("Nome do produto")
    ...
    if busca:
        ...
        if len(encontrados) == 1:
            ...
            escolha = st.selectbox("Mais de um produto encontrado com esse nome -- qual é?", nomes)
    ...
    with st.form("form_palavras_chave"):
        ...
        categoria = col2.selectbox("Categoria no ML", categorias, index=idx_cat)
