# Faixas de preco (limite superior de cada faixa) -- tabela oficial ML pos marco/2026
ML_FAIXAS_PRECO = [18.99, 48.99, 78.99, 99.99, 119.99, 149.99, 199.99, 999999]

# (limite superior de peso em kg, [valores por faixa de preco, na mesma ordem de ML_FAIXAS_PRECO])
ML_FRETE_TABELA = [
