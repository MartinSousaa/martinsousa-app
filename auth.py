...
def verificar_login():
    ...
    with col_left:
        ...
        if logo_b64:
            logo_html = (
                ...
                f'style="width:min(500px,75%); display:block; margin:0 auto;" alt="MS Studio"/>'
            )
        else:
            logo_html = """
            <div style="display:inline-block; text-align:center;">
                <div style="font-family:'Annai MN',Georgia,serif; font-size:120px; font-weight:700;
                            color:#fff; letter-spacing:-4px; line-height:1;">MS</div>
                <div style="font-family:Arial,sans-serif; font-size:13px; letter-spacing:8px;
                            color:rgba(255,255,255,0.45); margin-top:2px; text-transform:uppercase;">
                    MartinSousa</div>
            </div>
            """
        st.markdown(f"""
    ...
    with col_right:
        st.markdown("""
        <div style="width:100%; max-width:340px; margin:0 auto 28px;">
            <div style="
                font-family: 'Annai MN', 'Cormorant Garamond', Georgia, serif;
                font-size: 32px;
                font-weight: 400;
                color: #f0f0f0;
                letter-spacing: 0.5px;
