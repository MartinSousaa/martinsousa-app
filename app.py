...
/* Cobertura total: containers, filhos e atributo data-stale (Streamlit 1.45+) */
...
/* Impede pointer-events:none em inputs durante re-runs — elimina o "trava escrita" */
[data-testid="stMain"] input,
[data-testid="stMain"] textarea,
[data-testid="stMain"] select,
[data-testid="stSidebar"] input,
[data-testid="stSidebar"] textarea { pointer-events: auto !important; }

/* Remove backdrop do spinner sem esconder o texto de status */
...
if _eh_admin:
    ...
    if _gestao_ativa:
        if _eh_martinsousa:
            ...
            if auth.eh_dono(usuario_logado):
                _abas_g["Administrativo"] = lambda: admin.pagina_admin(usuario_logado)
            _navegar(_abas_g, "aba_g")
        else:
            _navegar({
                "🏆 Painel de Metas":  lambda: placar.pagina_placar(usuario_logado),
                "📊 Análise de Metas": lambda: analise_metas.pagina_analise_metas(usuario_logado),
