...
def _secao_configuracao(dados=None, carregar_periodo=None):
    ...
    # As Paradas mudaram de casa, por decisão do gestor: foram para
    # **Ponto › 🙋 Abonos**, ao lado dos pedidos de abatimento. Aqui elas
    # estavam a cinco cliques — Configuração de Metas, rolar até o fim —, e é
    # uma tela que se usa no meio de um problema, com o time parado esperando.
    #
    # Fica o ponteiro, e não o silêncio: quem já sabia onde era volta neste
    # ponto e precisa saber para onde ir, senão conclui que a função sumiu.
    st.markdown("##### 🛑 Paradas e períodos sem expediente")
    st.info("Isto agora fica em **Ponto › 🙋 Abonos**, junto com os pedidos "
            "de abatimento — as duas metades da mesma coisa, hora que não "
            "conta para os indicadores, na mesma tela.")
